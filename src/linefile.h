 ...
 * for now, at most, it can process a line with 9 int , 9 double, 9 string(char *), that means 45 parts in one line.
...
//generate a new LineFile, simply join two LineFile, No check on duplicate lines.
